...
const BuyStockPopup = ({ open, handleClose, stock }) => {
  ...
  const handleBuy = async () => {
    ...
    const response = await axios.post("http://127.0.0.1:5000/buy", { transaction_type: "BUY", name: stock.name, symbol: stock.symbol, price: Number(latestPrice), volume: quantity })
